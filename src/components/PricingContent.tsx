...
export default function PricingContent() {
  ...
  const { t, tArray, mounted } = useTranslation();
  
  // Get features from global translations
  const freeFeatures = tArray('pricing.freeTier.features');

  // Get faqs using global translations
  const faqs = [
  ...
  return (
    <>
      ...
      <section className="relative pt-20 sm:pt-24 md:pt-28 pb-8 sm:pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-2 dark:border-gray-800 mb-4 sm:mb-6">
            ...
            <span className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">{t('pricing.badge')}</span>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white dark:bg-[#1A1A1A] border border-gray-200 dark:border-2 dark:border-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8">
            <div className="flex items-center gap-3 mb-3 sm:mb-4">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">{t('pricing.freeTier.title')}</h3>
            </div>
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-4 sm:mb-6">{t('pricing.freeTier.subtitle')}</p>
      ...
      <section className="pb-12 sm:pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-6 sm:mb-8 text-center">{t('pricing.buyCredits')}</h2>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
            {creditPackages.map((pkg, index) => (
              ...
              >
                ...
                <h3 className="text-base sm:text-xl font-bold text-gray-900 dark:text-white mb-1 sm:mb-2">{pkg.credits} {t('pricing.credits')}</h3>
                ...
                <button className={`w-full py-2 sm:py-3 rounded-full font-semibold transition-all flex items-center justify-center gap-1 sm:gap-2 text-xs sm:text-base ${
                  ...
                  <span className="sm:hidden">{t('pricing.buyNow')}</span>
                </button>
              </div>
            ))}
          </div>
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-[#1A1A1A]">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">{t('pricing.faq.subtitle')}</p>
          </div>
