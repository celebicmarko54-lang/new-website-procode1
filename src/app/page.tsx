...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#f8fafc] dark:bg-[#0a0a0a] transition-colors">
      ...
      <section className="py-24 bg-[#f8fafc] dark:bg-[#0a0a0a] transition-colors">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6 tracking-tight">
              See λforge in Action
            </h2>
            
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Watch how easy it is to build production-ready apps with λforge.
            </p>
          </div>
          ...
          <div className="relative">
            {/* Glow effect */}
            <div className="absolute -inset-4 bg-gray-200/50 dark:bg-gray-700/50 rounded-[2.5rem] blur-2xl opacity-50"></div>
