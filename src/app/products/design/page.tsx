  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] dark:bg-black text-gray-900 dark:text-white transition-colors">
      ...
      <main className="pt-24 pb-16">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gray-100 dark:bg-black border border-gray-200 dark:border-gray-800 mb-6">
              ...
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">{t('productDesign.badge')}</span>
            </div>
            <h1 className="text-5xl md:text-6xl font-bold tracking-tight mb-6 text-gray-900 dark:text-white">
              {t('productDesign.title')} <span className="text-gray-500 dark:text-gray-400">{t('productDesign.titleHighlight')}</span>
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-3xl mx-auto">
              {t('productDesign.subtitle')}
            </p>
            <div className="flex items-center justify-center gap-4">
              <Link href="/signup" className="px-8 py-4 bg-black dark:bg-white text-white dark:text-black font-medium rounded-full hover:opacity-90 transition-all shadow-xl shadow-gray-900/20 dark:shadow-none">
                {t('productDesign.tryDesignTools')}
              </Link>
        ...
        <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="bg-white dark:bg-[#0a0a0a] rounded-2xl border border-gray-200 dark:border-gray-800 overflow-hidden shadow-xl">
            <div className="flex items-center gap-2 px-4 py-3 bg-gray-50 dark:bg-black border-b border-gray-200 dark:border-gray-800">
              ...
              <span className="ml-4 text-sm text-gray-500 dark:text-gray-400">{t('productDesign.visualEditor')}</span>
            </div>
            <div className="grid grid-cols-4 min-h-[400px]">
              {/* Left Panel - Components */}
              <div className="border-r border-gray-200 dark:border-gray-800 p-4">
                <div className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase mb-3">{t('productDesign.components')}</div>
              ...
              <div className="border-l border-gray-200 dark:border-gray-800 p-4">
                <div className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase mb-3">{t('productDesign.properties')}</div>
                <div className="space-y-4">
                  <div>
                    <label className="text-xs text-gray-500 dark:text-gray-400">{t('productDesign.width')}</label>
                  ...
                  <div>
                    <label className="text-xs text-gray-500 dark:text-gray-400">{t('productDesign.background')}</label>
                  ...
                  <div>
                    <label className="text-xs text-gray-500 dark:text-gray-400">{t('productDesign.borderRadius')}</label>
        ...
        {/* Features */}
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-900 dark:text-white">{t('productDesign.featuresTitle')}</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                icon: '🎨',
                title: t('productDesign.features.liveEditor.title'),
                description: t('productDesign.features.liveEditor.description')
              },
              {
                icon: '📐',
                title: t('productDesign.features.designSystem.title'),
                description: t('productDesign.features.designSystem.description')
              },
              {
                icon: '🧩',
                title: t('productDesign.features.componentLibrary.title'),
                description: t('productDesign.features.componentLibrary.description')
              },
              {
                icon: '📱',
                title: t('productDesign.features.responsive.title'),
                description: t('productDesign.features.responsive.description')
              },
              {
                icon: '🎯',
                title: t('productDesign.features.pixelPerfect.title'),
                description: t('productDesign.features.pixelPerfect.description')
              },
              {
                icon: '⚡',
                title: t('productDesign.features.instantDeploy.title'),
                description: t('productDesign.features.instantDeploy.description')
              }
            ].map((feature, i) => (
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          <h2 className="text-3xl font-bold mb-4 text-gray-900 dark:text-white">{t('productDesign.cta.title')}</h2>
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
            {t('productDesign.cta.subtitle')}
          </p>
          <Link href="/signup" className="inline-flex items-center gap-2 px-8 py-4 bg-black dark:bg-white text-white dark:text-black font-medium rounded-full hover:opacity-90 transition-all shadow-xl shadow-gray-900/20 dark:shadow-none text-lg">
            {t('productDesign.startDesigning')}
