  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] dark:bg-black text-gray-900 dark:text-white transition-colors">
      ...
      <main className="pt-24 pb-16">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-5xl md:text-6xl font-bold tracking-tight mb-6 text-gray-900 dark:text-white">
              Meet AppNode <span className="text-gray-500 dark:text-gray-400">Agent</span>
            </h1>
            ...
            <div className="space-y-4 font-mono text-sm">
              ...
              <div className="mt-4 p-4 bg-black rounded-lg border border-gray-800">
                ...
                <div className="mt-2 flex items-center gap-2">
                  ...
                  <span className="text-gray-400">Creating components, setting up data fetching...</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Features Grid */}
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-900 dark:text-white">How Agent Works</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-6 bg-white dark:bg-[#0a0a0a] rounded-xl border border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700 transition-colors">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">Describe Your Vision</h3>
            ...
            <div className="p-6 bg-white dark:bg-[#0a0a0a] rounded-xl border border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700 transition-colors">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">Watch It Build</h3>
              <p className="text-gray-600 dark:text-gray-400">
            ...
            <div className="p-6 bg-white dark:bg-[#0a0a0a] rounded-xl border border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700 transition-colors">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">Iterate & Improve</h3>
              <p className="text-gray-600 dark:text-gray-400">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-6 text-gray-900 dark:text-white">Autonomous Long Builds</h2>
            ...
            <div className="bg-gray-100 dark:bg-[#0a0a0a] border border-gray-200 dark:border-gray-800 rounded-2xl p-8">
              <div className="space-y-4">
                <div className="bg-white dark:bg-black rounded-xl p-4 border border-gray-200 dark:border-gray-800">
                  <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Files created</div>
                  <div className="text-2xl font-bold text-gray-900 dark:text-white">24</div>
                </div>
                <div className="bg-white dark:bg-black rounded-xl p-4 border border-gray-200 dark:border-gray-800">
                  <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Lines of code</div>
                  <div className="text-2xl font-bold text-gray-900 dark:text-white">3,847</div>
                </div>
                <div className="bg-white dark:bg-black rounded-xl p-4 border border-gray-200 dark:border-gray-800">
                  <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Build time</div>
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          <h2 className="text-3xl font-bold mb-4 text-gray-900 dark:text-white">Ready to build with AI?</h2>
