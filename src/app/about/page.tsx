...
export default function AboutPage() {
  ...
  const team = [
    { name: t('aboutPage.team.teamMember'), role: t('aboutPage.team.position'), image: '', bio: t('aboutPage.team.bioComingSoon') },
    { name: t('aboutPage.team.teamMember'), role: t('aboutPage.team.position'), image: '', bio: t('aboutPage.team.bioComingSoon') },
    { name: t('aboutPage.team.teamMember'), role: t('aboutPage.team.position'), image: '', bio: t('aboutPage.team.bioComingSoon') },
    { name: t('aboutPage.team.teamMember'), role: t('aboutPage.team.position'), image: '', bio: t('aboutPage.team.bioComingSoon') },
  ];
  ...
  const values = [
    ...
    { 
      ...
      title: t('aboutPage.values.userObsessed.title'), 
      description: t('aboutPage.values.userObsessed.description')
    },
    { 
      ...
      title: t('aboutPage.values.trustSecurity.title'), 
      description: t('aboutPage.values.trustSecurity.description')
    },
    { 
      icon: <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
      title: t('aboutPage.values.globalImpact.title'), 
      description: t('aboutPage.values.globalImpact.description')
    },
    { 
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] dark:bg-black text-gray-900 dark:text-white transition-colors">
      ...
      <main className="pt-24 pb-16">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">{t('aboutPage.team.title')}</h2>
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
