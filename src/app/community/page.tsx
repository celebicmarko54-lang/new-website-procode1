...
const featuredProjects = [
  ...
  { id: 11, title: 'pgt-quote', image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=600&q=80', category: 'B2B App', author: 'P', authorName: 'Paul G.', authorColor: 'bg-pink-500', remixes: 2 },
  ...
  { id: 20, title: 'velocargopro', image: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=600&q=80', category: 'Website', author: 'A', authorName: 'Adam F.', authorColor: 'bg-fuchsia-500', remixes: 1941 },
  ...
  { id: 25, title: 'ecommerce-starter', image: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=600&q=80', category: 'Website', author: 'E', authorName: 'Emma L.', authorColor: 'bg-pink-600', remixes: 7823 },
...
const topContributors = [
  { name: 'Sarah K.', projects: 45, avatar: 'SK', gradient: 'from-pink-500 to-rose-500' },
      ...
      <section className="relative pt-28 pb-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 mb-6 tracking-tight">
            Explore the
            <span className="bg-clip-text text-transparent" style={{ background: 'linear-gradient(135deg, #E91E8C 0%, #9B59B6 100%)', WebkitBackgroundClip: 'text' }}> Community</span>
          </h1>
          ...
          <div className="max-w-xl mx-auto">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 rounded-xl border border-gray-200 shadow-sm focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent text-base bg-white/80 backdrop-blur-sm"
              />
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-8 mt-12">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Active Builders</p>
            </div>
            <div className="text-center">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                {filteredProjects.map((project) => (
                  <div
                    key={project.id}
                    className="group bg-white rounded-xl border border-gray-100 overflow-hidden hover:shadow-lg transition-all hover:-translate-y-0.5 cursor-pointer"
                  >
                    {/* Project Preview */}
                    ...
                    <div className="p-3">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className={`px-2 py-0.5 rounded text-[10px] font-medium ${
                          project.category === 'Website' ? 'bg-orange-100 text-orange-700' :
                          project.category === 'Personal' ? 'bg-pink-100 text-pink-700' :
                          project.category === 'Internal Tools' ? 'bg-blue-100 text-blue-700' :
                          project.category === 'Consumer App' ? 'bg-green-100 text-green-700' :
                          project.category === 'B2B App' ? 'bg-purple-100 text-purple-700' :
                          project.category === 'Prototype' ? 'bg-yellow-100 text-yellow-700' :
                          'bg-gray-100 text-gray-700'
                        }`}>
                          {project.category}
                        </span>
                      </div>
                      <p className="text-xs text-pink-500">{project.remixes.toLocaleString()} Remixes</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="lg:w-80 space-y-6">
              ...
              {/* Discussions */}
              <div className="bg-gray-50 rounded-2xl p-5">
                <h3 className="font-semibold text-gray-900 mb-4">💬 Recent Discussions</h3>
                <div className="space-y-4">
                  {discussions.map((discussion) => (
                    <div key={discussion.id} className="border-b border-gray-200 pb-3 last:border-0 last:pb-0">
                      <p className="text-sm font-medium text-gray-900 hover:text-pink-600 cursor-pointer line-clamp-2">
                        {discussion.title}
                      </p>
                      <div className="flex items-center gap-2 mt-1">
                        <span className="text-xs px-2 py-0.5 bg-gray-200 text-gray-600 rounded">{discussion.category}</span>
              ...
              {/* Discord CTA */}
              <div className="bg-gradient-to-br from-[#ec4899] to-[#be185d] rounded-2xl p-5 text-white">
                ...
                <a
                  href="https://discord.gg/lovecode.dev"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block w-full py-2.5 bg-white text-pink-600 font-semibold rounded-lg text-center hover:bg-gray-100 transition-colors"
                >
                  Join Discord
                </a>
              </div>
