      ...
      <section className="relative pt-28 pb-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6 tracking-tight">
            {t('communityPage.exploreThe')}
            <span className="bg-clip-text text-transparent" style={{ background: 'linear-gradient(135deg, #1f2937 0%, #374151 100%)', WebkitBackgroundClip: 'text' }}> {t('communityPage.community')}</span>
          </h1>
          ...
          <div className="flex flex-wrap justify-center gap-8 mt-12">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">{t('communityPage.projectsCreated')}</p>
            </div>
            <div className="text-center">
              <p className="text-3xl font-bold text-gray-900 dark:text-white">12K+</p>
              <p className="text-sm text-gray-600 dark:text-gray-400">{t('communityPage.activeBuilders')}</p>
            </div>
            <div className="text-center">
              <p className="text-3xl font-bold text-gray-900 dark:text-white">1M+</p>
              <p className="text-sm text-gray-600 dark:text-gray-400">{t('communityPage.monthlyVisitors')}</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1">
              ...
              <div className="text-center mt-10">
                <button className="px-6 py-3 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-medium rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                  {t('communityPage.loadMoreProjects')}
                </button>
              </div>
            </div>
            ...
            <div className="lg:w-80 space-y-6">
              ...
              <div className="bg-gray-50 dark:bg-black/50 rounded-2xl p-5">
                <h3 className="font-semibold text-gray-900 dark:text-white mb-4">🏆 {t('communityPage.topContributors')}</h3>
              ...
              {/* Discussions */}
              <div className="bg-gray-50 dark:bg-black/50 rounded-2xl p-5">
                <h3 className="font-semibold text-gray-900 dark:text-white mb-4">💬 {t('communityPage.recentDiscussions')}</h3>
                ...
                <button className="w-full mt-4 text-sm text-gray-900 dark:text-white hover:text-gray-700 dark:hover:text-gray-300 font-medium">
                  {t('communityPage.joinDiscussion')} →
                </button>
              </div>
              ...
              <div className="bg-gradient-to-br from-[#1f2937] to-[#374151] rounded-2xl p-5 text-white">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="font-semibold text-lg">{t('communityPage.joinOurDiscord')}</h3>
                </div>
                <p className="text-sm text-white/80 mb-4">
                  {t('communityPage.discordDescription')}
                </p>
                <a
                ...
                >
                  {t('communityPage.joinDiscordButton')}
                </a>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-8">
            {t('communityPage.ctaDescription')}
          </p>
          <Link
            href="/"
