  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-14 flex">
        {/* Sidebar */}
        <aside className="hidden lg:block w-72 border-r border-gray-200 h-[calc(100vh-56px)] sticky top-14 overflow-y-auto">
          <div className="p-6">
            {/* Search */}
              ...
              {docsSections.map((section) => (
                <div key={section.title}>
                  <button
                    ...
                    className="flex items-center justify-between w-full px-3 py-2 text-left text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-lg transition-colors"
                  >
                    <span>{section.title}</span>
                    <svg 
                      className={`w-4 h-4 text-gray-400 transition-transform ${expandedSections.includes(section.title) ? 'rotate-90' : ''}`} 
                      fill="none" 
                      stroke="currentColor" 
                      viewBox="0 0 24 24"
                    >
        ...
        <main className="flex-1 max-w-4xl mx-auto px-6 py-12">
          ...
          <article className="prose prose-gray max-w-none">
            ...
            <div className="bg-gray-50 rounded-xl p-6 mb-8">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">What You Can Build</h3>
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <span className="text-gray-400">•</span>
                  <span className="text-gray-700">Full-stack web applications with databases</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-gray-400">•</span>
                  <span className="text-gray-700">Landing pages and marketing websites</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-gray-400">•</span>
                  <span className="text-gray-700">Dashboards and admin panels</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-gray-400">•</span>
                  <span className="text-gray-700">E-commerce stores and portfolios</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-gray-400">•</span>
                  <span className="text-gray-700">SaaS products and internal tools</span>
                </li>
              </ul>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
              <div className="bg-white border border-gray-200 rounded-xl p-4">
                ...
                <p className="text-sm text-gray-600">Tell AI what you want to build</p>
              </div>
              <div className="bg-white border border-gray-200 rounded-xl p-4">
                <h4 className="font-semibold text-gray-900 mb-2">Generate</h4>
                <p className="text-sm text-gray-600">AI writes production-ready code</p>
              </div>
              <div className="bg-white border border-gray-200 rounded-xl p-4">
                <h4 className="font-semibold text-gray-900 mb-2">Preview</h4>
                <p className="text-sm text-gray-600">See your app live instantly</p>
              </div>
              <div className="bg-white border border-gray-200 rounded-xl p-4">
                <h4 className="font-semibold text-gray-900 mb-2">Deploy</h4>
                <p className="text-sm text-gray-600">One-click deployment to production</p>
              </div>
            </div>
            ...
            <p className="text-gray-600 mb-6">
              Ready to build your first app? Here&apos;s how to get started in just a few steps:
            </p>
            ...
            <ol className="space-y-4 mb-8">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-medium text-gray-900">Sign up for free</h4>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-medium text-gray-900">Describe your app</h4>
                  <p className="text-sm text-gray-600">Tell us what you want to build in plain English.</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-medium text-gray-900">Watch it build</h4>
                  <p className="text-sm text-gray-600">See your app come to life in real-time.</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-gray-900 text-white rounded-full flex items-center justify-center text-sm font-medium">4</span>
                <div>
                  <h4 className="font-medium text-gray-900">Deploy with one click</h4>
                  <p className="text-sm text-gray-600">Share your app with the world instantly.</p>
                </div>
              </li>
            </ol>
