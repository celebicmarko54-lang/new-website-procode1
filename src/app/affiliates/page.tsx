  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-32 pb-20">
        ...
        <section className="px-6 mb-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 mb-6">
              Earn Money Sharing lovecode.dev
            </h1>
            ...
            <form onSubmit={handleSubmit} className="max-w-md mx-auto flex gap-3">
              <input
                ...
                className="flex-1 px-4 py-3 rounded-xl border border-gray-200 focus:border-pink-300 focus:ring-4 focus:ring-pink-100 outline-none transition-all"
              />
              <button
                type="submit"
              ...
              {tiers.map((tier, index) => (
                <div
                  ...
                  className={`rounded-2xl p-6 ${
                    tier.featured
                      ? 'bg-gradient-to-br from-[#ec4899] to-[#be185d] text-white ring-4 ring-pink-200'
                ...
                >
                  <div className="text-center mb-6">
                    ...
                    <p className={`text-sm ${tier.featured ? 'text-pink-100' : 'text-gray-500'}`}>
                  ...
                  <ul className="space-y-3">
                    {tier.perks.map((perk, i) => (
                      <li key={i} className="flex items-center gap-2">
                        <svg className={`w-5 h-5 ${tier.featured ? 'text-pink-200' : 'text-pink-500'}`} fill="currentColor" viewBox="0 0 20 20">
        ...
        {/* How It Works */}
        <section className="px-6 mb-20">
          <div className="max-w-4xl mx-auto bg-gradient-to-r from-pink-50 to-fuchsia-50 rounded-3xl p-8 md:p-12">
            <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">How It Works</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center text-pink-600 mx-auto mb-4 shadow-sm">
